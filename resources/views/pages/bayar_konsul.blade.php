...
<section class="w-full min-h-screen py-24 "
    ...
    <div class="relative max-w-screen-xl px-4 sm:px-8 mx-auto grid gap-x-6 overflow-hidden">
        <div data-aos="zoom-out-up" data-aos-duration="1000"
            ...
            <form action="{{ route('buktiBayarKonsul') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="flex flex-wrap -mx-3 mb-6" style="text-align:-webkit-center">
                    <div class="w-full px-10">
                        <label class="block uppercase font-[Fredoka] tracking-wide text-center text-white text-xs font-bold mb-2" for="bukti_bayar">
