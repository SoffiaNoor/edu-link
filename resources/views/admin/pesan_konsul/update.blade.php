                ...
                <div class="col-lg-12 mb-lg-0 mb-4 shadow-xl">
                    <div class="card p-2">
                        <div class="px-3 pt-2 font-weight-bold">
                            <h5 class="font-weight-bolder">Edit pesan_konsul:
                        ...
                        @endif
                        <form class="p-3" method="POST" action="{{ route('pesan_konsul.update',$pesan_konsul->IDpesan_konsul)}}" enctype="multipart/form-data">
                        @csrf 
                        @method('PUT') 
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="exampleFormControlInput1"
                                            value="{{$pesan_konsul->IDpesan_konsul}}" disabled name="IDpesan_konsul">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="exampleFormControlInput1"
                                            value="{{$pesan_konsul->Namapesan_konsul}}" name="Namapesan_konsul">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="exampleFormControlInput1"
                                            value="{{$pesan_konsul->Kapasitas}}" name="Kapasitas">
                                    </div>
                                </div>
                            </div>
