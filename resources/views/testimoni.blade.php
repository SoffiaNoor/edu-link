                ...
                <div class="p-6 xl:col-span-3">
                    <div class="grid gap-4 md:grid-cols-2">
                        ...
                        <div class="grid content-center gap-4">
                            <div class="p-6 rounded shadow-md bg-[#FFE200] text-black font-semibold"
                                data-aos="zoom-out-up" data-aos-duration="1000">
                                <p>Recomended banget, fast respon dan hasilnya top markotop.. gak nyesel deh order
                                    disini sesuai budget banget...</p>
                                <div class="flex items-center mt-4 space-x-4">
                                    <img src="{{ asset('assets/img/testimoni.png') }}" alt=""
                                        class="w-12 h-12 bg-center bg-cover rounded-full dark:bg-gray-500">
                                    <div>
                                        <p class="text-lg font-semibold">Santa Aldara</p>
                                        <div class="flex items-center space-x-1">
                                            <svg class="w-4 h-4 text-black-300" aria-hidden="true"
                                                xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                                viewBox="0 0 22 20">
                            ...
                            <div class="p-6 rounded shadow-md bg-[#FFE200] text-black font-semibold"
                                data-aos="zoom-out-up" data-aos-duration="1000">
                                <p>Terima kasih banyak sdh membuatkan logo kami. Kami sangat puas, fast respon, sabar dg
                                    aku yg super duper cerewet😄, hasilnya logo jg elegan sesuai dg yg kami inginkan.
                                    Murah tp tdk murahan😉 Sukses selalu ya....👍 </p>
                                <div class="flex items-center mt-4 space-x-4">
                                    <img src="{{ asset('assets/img/testimoni.png') }}" alt=""
                                        class="w-12 h-12 bg-center bg-cover rounded-full dark:bg-gray-500">
                                    <div>
                                        <p class="text-lg font-semibold">Berdiyani Eliyanti</p>
                                        <div class="flex items-center space-x-1">
                                            <svg class="w-4 h-4 text-black-300" aria-hidden="true"
                                                xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                                viewBox="0 0 22 20">
